...
#define MIN_COMHUNKMEGS 18
#ifdef MACOS_X
#define DEF_COMHUNKMEGS "64"
#define DEF_COMZONEMEGS "24"
#else
#define DEF_COMHUNKMEGS "18"
...
void Com_Frame( void ) {
	...
	if ( com_speeds->integer ) {
		...
		Com_Printf ("frame:%08x all:%3i sv:%3i\n      ev:%3i cl:%3i gm:%3i\n      rf:%3i bk:%3i\n", 
					 com_frameNumber, all, sv, ev, cl, time_game, time_frontend, time_backend );
	}	

	//waitforit("Com_frame 9");
	//
